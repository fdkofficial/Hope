...
def frame():
    ...
    if(os.path.exists("data.txt")):
        with open("data.txt","r") as f:
            ...
            label1=Label(f2,text="Welcome Back",fg="black",bg="#7CD7EA",font=("",15))
        ...
        sub.place(x=100,y=100,height=65,width=170)
...
btn2=PhotoImage(file='submit.png')
...
#img.place(x=0,y=0)
b2=Button(f1,height=1,width=4,text="Reset")
b2.place(x=460,y=380)
b2.configure(command=reset)
b2.bind("<Enter>",lambda e:b2.config(bg="#15A8AC"))
...
#lab.place(x=5,y=5)
gif_lab=Label(root,image="")
gif_lab.place(x=-25,y=40)
b1=Button(f1,height=60,width=140,image=btn1,bd=3,bg='#00242D',activebackground='#00242D',command=frame)
b1.place(x=380,y=290)
b1.bind("<Enter>",lambda e:b1.config(bg="#15A8AC"))
b1.bind("<Leave>",lambda e:b1.config(bg="#00242D"))
#animation(count)
root.mainloop()